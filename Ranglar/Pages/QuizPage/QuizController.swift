...
class QuizController: UIViewController {
    ...
    let answerButtona = AppButtons(title: "Qizil avtomobilga", fontSize: 18, bgcColor: .lightGray.withAlphaComponent(0.35), titleColor: .black, radius: 18, borderWidth: 1)
    let answerButtonb = AppButtons(title: "Ikkala avtomobilga", fontSize: 18, bgcColor: .lightGray.withAlphaComponent(0.25), titleColor: .black, radius: 18, borderWidth: 1)
    let answerButtonc = AppButtons(title: "\("Nogiron") taniqlik belgisi bo'lgan sariq avtomobilga", fontSize: 18, bgcColor: .lightGray.withAlphaComponent(0.25), titleColor: .black, radius: 18, borderWidth: 1)
    var score = 0
